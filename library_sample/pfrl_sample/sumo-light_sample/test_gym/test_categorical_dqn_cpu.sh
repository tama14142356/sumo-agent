...
python train_categorical_dqn_gym.py --eval-n-runs 1 --demo --monitor --load $model --eval-n-runs 100 --outdir $outdir/best_demo --gpu -1
model=$(find $outdir/train -name "*_finish")
python train_categorical_dqn_gym.py --eval-n-runs 1 --demo --monitor --load $model --eval-n-runs 100 --outdir $outdir/finish_demo --gpu -1
