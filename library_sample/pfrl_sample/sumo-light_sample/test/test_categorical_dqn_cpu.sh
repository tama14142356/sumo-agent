...
python train_categorical_dqn_gym.py --eval-n-runs 1 --demo --monitor --load $model --outdir $outdir/demo/best --gpu -1
model=$(find $outdir/train -name "*_finish")
python train_categorical_dqn_gym.py --eval-n-runs 1 --demo --monitor --load $model --outdir $outdir/demo/finish --gpu -1
