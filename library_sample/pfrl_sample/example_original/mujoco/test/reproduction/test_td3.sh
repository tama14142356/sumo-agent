...
CUDA_VISIBLE_DEVICES=$gpu python train_td3.py --env Pendulum-v0 --gpu 0 --steps 10 --replay-start-size 5 --batch-size 5 --outdir $outdir/train
model=$(find $outdir/train -name "*_finish")
CUDA_VISIBLE_DEVICES=$gpu python train_td3.py --env Pendulum-v0 --demo --load $model --eval-n-runs 1 --outdir $outdir/demo --gpu 0
